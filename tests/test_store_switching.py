from verialign.proxy.config import SQLITE_DEFAULT, get_settings, is_async_database
...
class TestConfigSwitching:
    def test_default_is_sqlite_url(self) -> None:
        settings = get_settings()
        assert settings.database_url == SQLITE_DEFAULT

    def test_database_url_overrides_db_path(self, monkeypatch) -> None:
    ...
    def test_mixed_settings_async_url_wins(self, monkeypatch) -> None:
